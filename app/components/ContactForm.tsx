            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="py-3 px-4 block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500  rounded-md   border border-gray-300"
                />
              </div>
            </div>
            <div>
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  id="phone-number"
                  autoComplete="tel"
                  className="py-3 px-4 block w-full pl-20 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md border ml-2"
