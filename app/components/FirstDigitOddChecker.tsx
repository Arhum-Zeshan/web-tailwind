...
export default function FirstDigitOddChecker() {
  ...
  const checkFirstOdd = () => {
    ...
    setResult(isFirstOdd ? "true" : "false");
    setColor(isFirstOdd ? "text-green-600" : "text-red-600");
  };

  return (
    <div className="flex flex-col items-center justify-center   p-4">
      <div className="bg-white p-6 rounded-2xl shadow-xl w-full max-w-sm text-center">
        <h1 className="text-xl font-bold mb-4">First Digit Checker</h1>
        <input
          type="number"
          value={input}
